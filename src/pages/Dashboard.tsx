                      ...
                      <TableBody>
                        {paginatedRecords.map((record) => {
                          ...
                          >
                            ...
                            <TableCell className="py-4 px-2 text-sm" style={{whiteSpace: 'nowrap', textAlign: 'left', width: '120px'}} data-label="Village">{record.village || record.subDistrict || <span className="text-muted-foreground italic">-</span>}</TableCell>
